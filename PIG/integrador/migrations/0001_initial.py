# Generated by Django 3.2.18 on 2023-05-22 20:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_baja', models.DateField(default=None, null=True, verbose_name='Fecha de Baja')),
                ('coordenada_domicilio', models.CharField(max_length=50, verbose_name='Coordenadas domicilio')),
                ('legajo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='integrador.empleado')),
            ],
            options={
                'abstract': False,
            },
